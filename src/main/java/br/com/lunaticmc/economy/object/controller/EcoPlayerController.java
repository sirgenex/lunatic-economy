package br.com.lunaticmc.economy.object.controller;
...
public class EcoPlayerController {
    ...
    @Getter private static final EcoPlayerController instance = new EcoPlayerController();
    ...
    @Getter @Setter private EcoPlayer magnata;
    ...
    public void saveAll(FileConfiguration c){
        cache.forEach((player, value) -> c.set("players." + player + ".balance", value.getBalance()));
        if(magnata != null) c.set("magnata", magnata.getName());
    }
